...
GO
INSERT INTO [dbo].[Invoices] (Id, Number, Account, KindId, ProviderId, MonthId, Year, Sum, Debt, CreatedAt) 
	VALUES(1, N'1234-F56', N'71', 1, 1, 3, 2016, 164.4, null, CONVERT(datetime, N'30.08.2016', 104))
INSERT INTO [dbo].[Invoices] (Id, Number, Account, KindId, ProviderId, MonthId, Year, Sum, Debt, CreatedAt) 
	VALUES(2, N'80-895-12', N'5435454343454354354534', 3, 2, 7, 2016, 2600, null, CONVERT(datetime, N'01.09.2016', 104))
INSERT INTO [dbo].[Invoices] (Id, Number, Account, KindId, ProviderId, MonthId, Year, Sum, Debt, CreatedAt) 
	VALUES(3, N'123456', N'0000000000', 1, 1, 8, 2016, 124.56, 40,  CONVERT(datetime, N'01.09.2016', 104))
INSERT INTO [dbo].[Invoices] (Id, Number, Account, KindId, ProviderId, MonthId, Year, Sum, Debt, CreatedAt) 
	VALUES(4, N'145', N'946546', 4, 2, 7, 2016, 56, null, CONVERT(datetime, '20.08.2016', 104))
INSERT INTO [dbo].[Invoices] (Id, Number, Account, KindId, ProviderId, MonthId, Year, Sum, Debt, CreatedAt) 
	VALUES(5, N'АБ567', N'71018946546', 6, 4, 5, 2016, 500.45, 134.90, CONVERT(datetime, N'20.08.2016', 104))
GO
